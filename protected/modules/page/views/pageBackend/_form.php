...
<ul class="nav nav-tabs">
    ...
    <li><a href="#desc" data-toggle="tab"><?= Yii::t("PageModule.page", "Параметры"); ?></a></li>
</ul>
...
<div class="tab-content">
            ...
            <div class="col-sm-7">
                <?= $form->textFieldGroup(
                    ...
                    [
                        'widgetOptions' => [
                            'htmlOptions' => [
                                'data-original-title' => $model->getAttributeLabel('desc_img'),
                                'data-content' => $model->getAttributeDescription('desc_img')
                            ],
                        ],
                    ]
                ); ?>
            ...
            <div class="col-sm-7">
                <?= $form->textFieldGroup(
                    ...
                    [
                        'widgetOptions' => [
                            'htmlOptions' => [
                                'data-original-title' => $model->getAttributeLabel('svg1'),
                                'data-content' => $model->getAttributeDescription('svg1')
                            ],
                        ],
                    ]
                ); ?>
            ...
            <div class="col-sm-7">
                <?= $form->textFieldGroup(
                    ...
                    [
                        'widgetOptions' => [
                            'htmlOptions' => [
                                'data-original-title' => $model->getAttributeLabel('svg2'),
                                'data-content' => $model->getAttributeDescription('svg2')
                            ],
                        ],
                    ]
                ); ?>
    ...
    <div class="tab-pane" id="desc">
                ...
                <?= $form->textAreaGroup(
                    ...
                    [
                        'widgetOptions' => [
                            'htmlOptions' => [
                                "rows" => 12,
                                'data-original-title' => $model->getAttributeLabel('character'),
                                'data-content' => $model->getAttributeDescription('character')
                            ],
                        ],
                    ]
                ); ?>
        ...
        <div class="row">
            <div class="col-sm-12 popover-help" data-original-title='<?= $model->getAttributeLabel('shema'); ?>'
                 data-content='<?= $model->getAttributeDescription('shema'); ?>'>
                <?= $form->labelEx($model, 'shema'); ?>
                <?php
                $this->widget(
                    $this->module->getVisualEditor(),
                    [
        ...
        <div class="row">
            <div class="col-sm-12 popover-help" data-original-title='<?= $model->getAttributeLabel('sertificate'); ?>'
                 data-content='<?= $model->getAttributeDescription('sertificate'); ?>'>
        ...
        <!-- <div class="row">
            <div class="col-sm-12 popover-help" data-original-title='<?= $model->getAttributeLabel('delivery'); ?>'
                 data-content='<?= $model->getAttributeDescription('delivery'); ?>'>
