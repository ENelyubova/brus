...
/**
   ...
   */
    ...
    /*Цвет ссылок меню*/
    $('.main-screen__left').hover(function(){
        $('.abs-block').addClass('abs-block-hover');
        $('.menu ul li:nth-child(2) a').addClass('white-link');
        
    }, /*Абсолютный блок*/
        function(){
        $('.abs-block').removeClass('abs-block-hover');
        $('.menu ul li:nth-child(2) a').removeClass('white-link');
    });
    ...
    /* Подгрузить  капчу */
    // $(document).delegate('a[data-target]', 'click', function (e) {
    //     var head = document.getElementsByTagName('head')[0];
    //     var script = document.createElement('script');
    //     $.getScript('https://www.google.com/recaptcha/api.js', function () {});
    //     head.appendChild(script);
    ...
    if($('div').hasClass('product-carousel')){
        var prodSlide = $('.product-carousel');
        prodSlide.on('init reInit afterChange', function(event, slick, currentSlide, nextSlide){
        });
        prodSlide.slick({
            fade: false,
            infinite: false,
    ...
    /*Миниатюры галерея*/
    if($('div').hasClass('gallery-carousel-thumb')){
